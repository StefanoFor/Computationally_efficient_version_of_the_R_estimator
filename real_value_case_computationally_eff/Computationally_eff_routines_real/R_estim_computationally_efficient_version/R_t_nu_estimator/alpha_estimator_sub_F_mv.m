function [alpha_est, Delta_T, W] = alpha_estimator_sub_F_mv(y, T, V, nu, m_index)
...
[Delta_T, W, inv_T] = Delta_eval_F_mv(y, T, nu, m_index);

% Evaluation of the perturbed approximation of the efficient central sequence Delta_T
T_pert = T + V/sqrt(K);
Delta_T_pert = Delta_only_eval_F_mv(y, T_pert, nu, m_index);
